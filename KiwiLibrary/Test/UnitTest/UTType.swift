...
public func UTType(context ctxt: KEContext, console cons: CNConsole) -> Bool
{
	...
	let url = URL(string: "https://gitlab.com/steelwheels")
	...
	let coreimg = CNImage(byReferencing: URL(string: "https://gitlab.com/steelwheels/Amber/blob/master/Document/Images/AmberPlayerLogo.png")!)

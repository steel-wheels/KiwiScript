...
function decode(formats: CommandLine.Format[], argv: string[])
{
	...
	if(retval != null){
		let args: Array<CommandLine.Argument> = retval ;
		for(let arg of args){
			switch(arg.type) {

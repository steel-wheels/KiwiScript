...
private let ApplicationName = "edecl"
...
public class CommandLineParser
{
	...
	private func printUsage() {
		mConsole.print(string: "usage: \(ApplicationName) [options] [file-name] (option \"-h\" for help)\n")
	}

	private func printHelpMessage() {
		mConsole.print(string: "usage: \(ApplicationName) [options] [frame-name]\n" +
		"  [options]\n" +
	...
	private func printVersionMessage() {
                ...
                if let plist = CNPropertyList.loadFromBundle(name: "edecl_bundle.bundle"){
